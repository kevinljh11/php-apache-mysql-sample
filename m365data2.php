...
if (abs($chupan)>=$gpan && (($chupan<0 && $zhufen<=$kefen) or ($chupan>0 && $zhufen>=$kefen)))
{
$out1.=$id.",(".$plus."),".$gametime."',(".$chupan.",".sprintf("%.2f",$chudx)."),(".$zhufen."-".$kefen.")".$gggame[5].",".$gggame[13]."[".$zhupos."] vs [".$kepos."]".$kename."<br>";
}
}
}
}
